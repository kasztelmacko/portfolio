      ...
      <div className="w-[40%] bg-white p-4">
        <div className="grid h-full gap-4 grid-cols-4 grid-rows-[repeat(6,1fr)]">
          <a 
            ...
            className="col-span-1 row-span-1 border-2 border-black rounded-xl bg-cyan-700 flex items-center justify-center"
          >
            <svg 
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="col-span-1 row-span-1 border-2 border-black rounded-xl bg-purple-200 flex items-center justify-center"
          >
            <svg 
              className="w-8 h-8" 
              viewBox="0 0 24 24" 
          ...
          <a href="https://example.com/3" className="col-span-2 row-span-2 border-2 border-black rounded-xl bg-red-500"></a>
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="col-span-1 row-span-2 border-2 border-black rounded-xl bg-stone-800 flex items-center justify-center"
          >
            <svg 
          ...
          <a href="https://example.com/6" className="col-span-2 row-span-2 border-2 border-black rounded-xl bg-lime-300"></a>
          <div className="col-span-1 row-span-2 border-2 border-black rounded-xl"></div>
          <div className="col-span-1 row-span-1 border-2 border-black rounded-xl"></div>
          <a href="https://example.com/7" className="col-span-3 row-span-1 border-2 border-black rounded-xl bg-amber-200"></a>
          <div className="col-span-1 row-span-1 border-2 border-black rounded-xl"></div>
        </div>
      </div>
    </main>
