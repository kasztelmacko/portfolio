const SalesProject = () => {
    return (
        ...
        <div className="mb-4">
            ...
            <div>After completing the EDA, I moved on to <b>feature engineering</b>. Initially, I handled missing oil price data by filling in the gaps with the previous day's value. I then added <b>Fourier features</b>, which helped capture seasonal trends by representing the time series using a series of sine and cosine functions. To avoid dealing with raw date values in the model, I transformed the date column into separate columns for the <b>year, month, day, end-of-month, and payday</b>, making it easier for the model to interpret.</div>
